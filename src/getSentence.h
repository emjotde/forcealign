...
public:
    ...
    void rewind();
    virtual int getNextSentence(sentPair&, vcbList* = 0, vcbList* = 0);  // will be defined in the definition file, this
...
private:    
    virtual bool readNextSentence(sentPair&);  // will be defined in the definition file, this
};
